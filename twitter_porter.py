...
def requestForUserInfo(client, user_id):
	# 180 requests / 15 min
	print "%s: Requesting user information from twitter ..." % user_id
	...
	# 300 requests / 15 min
	print "%s: Calculating favorite_count and retweet_count ... " % user_id
...
def insertNewUser(cur, user):
	print "Inserting new user '%s' into db ... " % user['id_str']
